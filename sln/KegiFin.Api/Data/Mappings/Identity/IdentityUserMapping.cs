...
public class IdentityUserMapping : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.NormalizedEmail).IsRequired().HasMaxLength(180);
        builder.Property(u => u.UserName).IsRequired().HasMaxLength(180);
        builder.Property(u => u.NormalizedUserName).IsRequired().HasMaxLength(180);
